...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-8 col-md-7">
                                    <div class="row">
                                        ...
                                        <%--CommandName="cmdDelete" CommandArgument='<%#Eval("productId")%>' OnCommand="lbDelete_Command"--%>
                                        <%--<div class="col-2">
                                            <asp:LinkButton ID="lbDeleteWishListItem"  runat="server">
        ...
        <br />
        <br />
            Total Amount: <asp:TextBox ID="tAmount" runat="server" Enabled="False"></asp:TextBox>
