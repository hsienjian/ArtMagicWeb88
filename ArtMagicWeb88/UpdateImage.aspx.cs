...
namespace ArtMagicWeb88
{
    public partial class WebForm2 : System.Web.UI.Page
    {
        ...
        protected void ShowData()
        {
            ...
            con.Open();
            adapt = new SqlDataAdapter("Select * from product Where userid = " + Session["Artist_id"].ToString(), con);
            adapt.Fill(dt);
            if (dt.Rows.Count > 0)
            {
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            {
                {
                    string sql = "Update product set image = @image,ContentType = @ContentType,Data = @Data where productId = " + Convert.ToInt32(id.Text);
